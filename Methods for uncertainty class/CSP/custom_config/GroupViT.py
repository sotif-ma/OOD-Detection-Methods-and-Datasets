...
model = dict(
    ...
    group_fuse_num=None,
    classifier=dict(
        type='GroupViTClassifier',
        arch=model_name,
        train_dataset='imagenet',
        # wordnet_database='/data/wordnet/txtfiles/',
        # wordnet_database='/data_SSD2/cmy/wordnet/txtfiles/',
        wordnet_database='/data_SSD1/cmy/csp-submit/txtfiles/',
        # wordnet_database='/data_SSD1/cmy/NegLabel-official/txtfiles_complete/',
        txt_exclude=
        # 'noun.animal.txt,noun.food.txt,'
        'noun.person.txt,noun.quantity.txt,noun.group.txt,'
        'adj.pert.txt',
        # 'noun.time.txt',
        # 'noun.cognition.txt,noun.feeling.txt,'
        # 'noun.communication.txt,'
        # 'noun.possession.txt,noun.motive.txt',
        neg_subsample=-1,
        pos_neg_sim='neg_centroid',
        neg_topk=0.15,  # percentage
        # neg_topk=0.2,  # percentage
        emb_batchsize=1000,
        prompt_idx_pos=85,  # [0,80]
        # prompt_idx_pos=87,  # [0,80]
        prompt_idx_neg=85,  # [0,80]
        # prompt_idx_neg=87,  # [0,80]
        # dump_neg=True,
        dump_neg=False,
        # load_dump_neg=True,
        load_dump_neg=False,
